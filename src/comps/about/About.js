...
const About = () => {
    ...
    const paraArr =
        [
            "Hello there! 👋 My name is Mayank and I'm from Firozabad, WB. As a Full-Stack software developer, I specialize in creating visually appealing websites, apps and mobile games. My passion for graphic design isn't just a hobby, it's a key ingredient in every project I work on.",
